...
namespace Kuharica_finalno
{
    public partial class Kuharica : Form
    {
        ...
        private void Popis_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
        ...
        private void Kuharica_Load(object sender, EventArgs e)
        {
            SviRecepti();
        }

        private void Recept_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            Random rnd = new Random();  //biramo random broj kako bi mogli ponuditi detalje random recepta
            int br = rnd.Next(1, recepti.Count());

            for (int i=1;i<recepti.Count();i++)
            {
                    if (i == br)
                    {
        ...
        private void NoviRecept_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            MessageBox.Show("U razvoju");
        }

        private void Oaplikaciji_ItemClick(object sender, DevExpress.XtraEditors.TileItemEventArgs e)
        {
            MessageBox.Show("Najjednostavniji recepti za kulinarski neiskusne adolescente !");
        }
    }
}
